...
typedef struct _nodo_D
{
    ...
    _nodo_D* cero;            /* Puntero a la rama cero de un árbol */
    _nodo_D* uno;             /* Puntero a la rama uno de un árbol */
...
/////// Función principal para descomprimir archivos ///////
int Descomprimir(int argc, char* argv[]) // Descomprimir
{
    ...
    BorrarArbol_D(Arbol);                 /* Borramos el árbol */
    return 0;
}

/////// Función principal para comprimir archivos ///////
int Comprimir(int argc, char* argv[]) // Compresion
{
    ...
    int nBits;               /* Número de bits usados */
...
/* Función recursiva para borrar un arbol / Descomprimir */
